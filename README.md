...
Das Model umfasst das GameMode Entity, eine World Entity sowie Objekten, welche sich in einem Level befinden und von einer Basisklasse (Actor) erben. Actor enthält die grundlegenden Informationen über ein Spielobjekt (Spielfigur, Teile der Welt, ...), um es in einem Level positionieren sowie Kollision abfragen zu können.
